            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table" role="presentation">
                    <tbody>
                        <tr>
                            <th scope="row">
                                <label for="vintel_zoho_client_id"><?php esc_html_e( 'Zoho Client ID', 'vintel-zoho-desk-connector' ); ?></label>
                            </th>
                            <td>
                                <input name="vintel_zoho_client_id" type="text" id="vintel_zoho_client_id" value="<?php echo esc_attr( get_option( 'vintel_zoho_client_id' ) ); ?>" class="regular-text" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">
                                <label for="vintel_zoho_client_secret"><?php esc_html_e( 'Zoho Client Secret', 'vintel-zoho-desk-connector' ); ?></label>
                            </th>
                            <td>
                                <input name="vintel_zoho_client_secret" type="text" id="vintel_zoho_client_secret" value="<?php echo esc_attr( get_option( 'vintel_zoho_client_secret' ) ); ?>" class="regular-text" />
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">
                                <label for="vintel_zoho_redirect_uri"><?php esc_html_e( 'Redirect URI', 'vintel-zoho-desk-connector' ); ?></label>
                            </th>
                            <td>
                                <input name="vintel_zoho_redirect_uri" type="text" id="vintel_zoho_redirect_uri" value="<?php echo esc_attr( get_option( 'vintel_zoho_redirect_uri' ) ); ?>" class="regular-text" />
                            </td>
                        </tr>
                    </tbody>
                </table>
